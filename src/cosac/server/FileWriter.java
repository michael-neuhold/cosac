...
public class FileWriter<T> {
    ...
    public static void main(String[] args) {
        ...
        UserData user2 = new UserData("S2", "Michael", "Neuhold","michi.neuhold@gmail.com", "password#", Role.STUDENT, false);
        UserData user3 = new UserData("S3", "Michael", "Neuhold","michi.neuhold@gmail.com", "password#", Role.STUDENT, false);
